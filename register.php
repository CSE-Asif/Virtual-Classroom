	...
	<div class="container-fluid">
		<div class="row ">
			...
			<div class="col-lg-6 col-md-6 infinity-form-container">				
				...
				<form action="registration.php" method="post" class="px-3">
						
					<div class="form-input">
						<span><i class="fa fa-address-card" aria-hidden="true"></i></span>
						<input type="text" class="phn" name="fname" placeholder="First Name" required >
					</div>

					<div class="form-input">
						<span><i class="fa fa-address-card" aria-hidden="true"></i></span>
						<input type="text" class="phn" name="lname" placeholder="Last Name" required >
					</div>

					<div class="form-input">
						<span><i class="fa fa-envelope" aria-hidden="true"></i></span>
						<input type="text" class="phn" name="email" placeholder="Email" required >
					</div>

					<div class="form-input">
						<span><i class="fa fa-user-circle" aria-hidden="true"></i></span>
						<input type="text" class="phn" name="uname" placeholder="Username" required >
					</div>
						...
						<div class="form-input">
			      		...
			      		<div class="mb-3"> 
							<button type="submit" value="Register"  onclick="f1()" class="btn btn-block">Register</button>
						</div>
